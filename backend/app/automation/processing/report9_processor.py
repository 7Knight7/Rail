    ...
    def process(
        ...
        *,
        ...
        return ProcessingResult(
            ...
            output_columns=list(OUTPUT_HEADERS),
            visible_columns=list(OUTPUT_HEADERS),
            selected_column_ids=["sno", "cause", "received", "share_percent"],
            column_order=["sno", "cause", "received", "share_percent"],
